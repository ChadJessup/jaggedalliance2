...
BOOLEAN InitializeVideoManager(HINSTANCE hInstance, UINT16 usCommandShow, void* WindowProc)
{
	...
	ReturnCode = IDirectDraw2_CreateSurface(
		gpDirectDrawObject, 
		&SurfaceDescription, 
		&_gpBackBuffer, 
		NULL);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
void ScrollJA2Background(
	UINT32 uiDirection, 
	INT16 sScrollXIncrement, 
	INT16 sScrollYIncrement, 
	LPDIRECTDRAWSURFACE2 pSource, 
	LPDIRECTDRAWSURFACE2 pDest, 
	BOOLEAN fRenderStrip, 
	...
	if (guiFrameBufferState == BUFFER_DIRTY)
	{
			...
			//
		{
			if (gfForceFullScreenRefresh == TRUE)
			{
				...
				Region.left = 0;
				Region.top = 0;
				Region.right = 640;// usScreenWidth;
				Region.bottom = 480;// usScreenHeight;
