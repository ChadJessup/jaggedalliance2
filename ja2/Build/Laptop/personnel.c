...
void DisplayCharName( INT32 iId, INT32 iSlot )
{
	...
	else
  {
		...
		{
			wprintf( sTownName, L"%s", pTownNames[ bTownId ] );
		}
	}
	...
	{
		//nick name - town name
		wprintf( sString, L"%s - %s", gMercProfiles[Menptr[iId].ubProfile].zNickname, sTownName );
	}
	else
	{
		//nick name
		wprintf( sString, L"%s", gMercProfiles[Menptr[iId].ubProfile].zNickname );
	}
	...
	wprintf( sString, L"%s", pPersonnelAssignmentStrings[Menptr[iId].bAssignment]);
		...
		switch(iCounter)
		{
		 case 0:
			 ...
			 if( Menptr[iId].bAssignment != ASSIGNMENT_POW )
			 {
				...
				{
					wprintf(sString, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bLifeDelta);
			 ...
			 //else
			 //{
				 wprintf(sString, L"%d/%d",Menptr[iId].bLife,Menptr[iId].bLifeMax);
			 //}
			 }
			 else
			 {
				 wprintf( sString, pPOWStrings[ 1 ] );
			 }
       ...
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 ...
		 case 1:
			 ...
			 if( !fAmIaRobot )
			 {
				 ...
				 {
					 wprintf(sString, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bAgilityDelta);
					 FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 		 mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
					 wprintf(sString, L"%d",Menptr[iId].bAgility);
				 //}
			 }
			 else
			 {
				 wprintf( sString, L"%s", gpStrategicString[ STR_PB_NOTAPPLICABLE_ABBREVIATION ] );
			 }
		 ...
		 case 2:
		  // dexterity
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						wprintf(sString, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bDexterityDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		wprintf(sString, L"%d",Menptr[iId].bDexterity);
				 //}
			 }
			 else
			 {
       ...
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 ...
		 // strength
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						wprintf(sString, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bStrengthDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		wprintf(sString, L"%d",Menptr[iId].bStrength );
				 //}
			 }
			 else
			 {
		 ...
		 case 4:
		  // leadership
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						wprintf(sString, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bLeadershipDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20 +TEXT_DELTA_OFFSET),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		wprintf(sString, L"%d",Menptr[iId].bLeadership );
				 //}
			 }
			 else
			 {
		 ...
		 case 5:
		  // wisdom
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						wprintf(sString, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bWisdomDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 
				 }
				 //else
				 //{
				 		wprintf(sString, L"%d",Menptr[iId].bWisdom );
				 //}
			 }
			 else
			 {
		 ...
		 case 6:
		  // exper
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						wprintf(sString, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bExpLevelDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20 +TEXT_DELTA_OFFSET),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);
				 }
				 //else
				 //{
				 		wprintf(sString, L"%d",Menptr[iId].bExpLevel );
				 //}
			 }				
			 else
			 {
       ...
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 ...
		 case 7:
			 ...
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						wprintf(sString, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bMarksmanshipDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		wprintf(sString, L"%d",Menptr[iId].bMarksmanship);
				 //}
			 }
			 else
			 {
     ...
     case 8:
		  // mech
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						wprintf(sString, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bMechanicDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
					 wprintf(sString, L"%d",Menptr[iId].bMechanical);
				 //}
			 }
			 else
			 {
     ...
     case 9:
		  // exp
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						wprintf(sString, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bExplosivesDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		wprintf(sString, L"%d",Menptr[iId].bExplosive);
				 //}
       ...
       // med
			 if( !fAmIaRobot )
			 {
				 ...
				 {
					 wprintf(sString, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bMedicalDelta);
					 FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20 +TEXT_DELTA_OFFSET),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 		 mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		wprintf(sString, L"%d",Menptr[iId].bMedical);
				 //}
			 }
			 else
			 {
      ...
      mprintf((INT16)(pPersonnelScreenPoints[21].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[21].y,pPersonnelScreenStrings[PRSNL_TXT_KILLS]);		 
			wprintf(sString, L"%d",gMercProfiles[Menptr[iId].ubProfile].usKills);
      ...
      mprintf(sX,pPersonnelScreenPoints[21].y,sString);
		 ...
		 case 15:
			...
			wprintf(sString, L"%d",gMercProfiles[Menptr[iId].ubProfile].usAssists);
      ...
      sX += StringPixLength( L"%",  PERS_FONT );
		 ...
		 break;
		  case 17:
			...
			wprintf(sString, L"%d",gMercProfiles[Menptr[iId].ubProfile].usBattlesFought);
      ...
      mprintf(sX,pPersonnelScreenPoints[24].y,sString);
		 ...
		 case 18:
			...
			wprintf(sString, L"%d",gMercProfiles[Menptr[iId].ubProfile].usTimesWounded);
		 ...
		 break;
			...
			case 19:
			{
				...
				if( !fAmIaRobot )
				{
					...
					{
						wprintf( sString, L"%s %s", gzMercSkillText[bSkill1], gzMercSkillText[NUM_SKILLTRAITS] );
					...
					else
					{
						...
						{
							wprintf( sString, L"%s", gzMercSkillText[bSkill1] );
						...
						{
							wprintf( sString, L"%s", gzMercSkillText[bSkill2] );
						...
						{
							wprintf( sString, L"%s", pPersonnelScreenStrings[ PRSNL_TXT_NOSKILLS ] );
...
/*
		 case 19:
			...
			{
				wprintf(sString, L"%d %s",gMercProfiles[Menptr[iId].ubProfile].usTotalDaysServed - 1, gpStrategicString[ STR_PB_DAYS_ABBREVIATION ] );
			}
			else
			{
				wprintf(sString, L"%d %s",gMercProfiles[Menptr[iId].ubProfile].usTotalDaysServed, gpStrategicString[ STR_PB_DAYS_ABBREVIATION ] );
			}
      FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[24].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
      mprintf(sX,pPersonnelScreenPoints[24].y,sString);
		 break;
...
void DrawPageNumber( void )
{
  ...
  iPageNumber++;
	...
	wprintf(sString, L"%d/%d", iPageNumber, iLastPage);
		...
		if( pSoldier->inv[ ubCounter ].ubNumberOfObjects )
		{
			...
			else
			{
				...
				if ( Item[pSoldier->inv[ ubCounter ].usItem ].usItemClass & IC_AMMO )
				{
					...
					wprintf( sString, L"%d/%d", iTotalAmmo, ( pSoldier->inv[ ubCounter ].ubNumberOfObjects * Magazine[ Item[pSoldier->inv[ ubCounter ].usItem ].ubClassIndex ].ubMagSize ) );
				...
				{
						wprintf( sString, L"%2d%%%%", pSoldier->inv[ ubCounter ].bStatus[0] );
						FindFontRightCoordinates( ( INT16 )( PosX + 65 ), ( INT16 ) ( PosY + 15 ), ( INT16 ) ( 171 - 75 ), 
							( INT16 )( GetFontHeight( FONT10ARIAL ) ), sString, FONT10ARIAL, &sX, &sY );
				...
				{
					wprintf( sString, L"%s", AmmoCaliber[ Weapon[ Item[  pSoldier->inv[ ubCounter ].usItem ].ubClassIndex ].ubCalibre ]);
				...
				if( pSoldier->inv[ ubCounter ].ubNumberOfObjects > 1 )
				{
					wprintf( sString, L"x%d",  pSoldier->inv[ ubCounter ].ubNumberOfObjects );
...
void DisplayNumberOnCurrentTeam( void )
{
	...
	if( fCurrentTeamMode == TRUE )
	{
		wprintf( sString, L"%s ( %d )", pPersonelTeamStrings[ 0 ], GetNumberOfMercsDeadOrAliveOnPlayersTeam( ) );
		sX = PERS_CURR_TEAM_X;
	}
	else
	{
		wprintf( sString, L"%s", pPersonelTeamStrings[ 0 ] );
...
void DisplayNumberDeparted( void )
{
	...
	if( fCurrentTeamMode == FALSE )
	{
		wprintf( sString, L"%s ( %d )", pPersonelTeamStrings[ 1 ], GetNumberOfPastMercsOnPlayersTeam( ) );
		sX = PERS_CURR_TEAM_X;
	}
	else
	{
		wprintf( sString, L"%s", pPersonelTeamStrings[ 1 ] );
		FindFontCenterCoordinates( PERS_CURR_TEAM_X, 0, 65, 0,sString, FONT10ARIAL, &sX, &sY );
	}
...
void DisplayCostOfCurrentTeam( void )
{
	...
	if( fCurrentTeamMode == TRUE )
	{
	  ...
	  wprintf( sString, L"%d", GetTotalDailyCostOfCurrentTeam( ) );
	  ...
	  wprintf( sString, L"%d", GetHighestDailyCostOfCurrentTeam( ) );
		InsertCommasForDollarFigure( sString );
		InsertDollarSignInToString( sString );
	  ...
	  wprintf( sString, L"%d", GetLowestDailyCostOfCurrentTeam( ) );
		InsertCommasForDollarFigure( sString );
		InsertDollarSignInToString( sString );
  ...
  if( ( GetNumberOfMercsDeadOrAliveOnPlayersTeam( ) == 0 ) && (  fCurrentTeamMode == TRUE ) )
	...
	for( iCounter = 0; iCounter < 11; iCounter++ )
	{
		...
		if(  fCurrentTeamMode == TRUE )
		{
			...
			if( iValue == -1 )
				wprintf( sString, L"%s", pPOWStrings[ 1 ] );
			else
				wprintf( sString, L"%d", iValue );

		}
		else
		{
			wprintf( sString, L"%d", GetAvgStatOfPastTeamStat( iCounter ) );
		}
		// center
...
//				continue;
		...
		if( fCurrentTeamMode == TRUE )
		{
			...
			if( iId == -1 )
				...
				wprintf( sString, L"%s", MercPtrs[ iId ] -> name );
		}
		else
		{
			// get name
			wprintf( sString, L"%s", gMercProfiles[ iDepartedId ].zNickname );
		}
		// print name
...
//			continue;
		...
		{
			// get name
			wprintf( sString, L"%s", gMercProfiles[ iId ].zNickname );
		}
		// print name
...
void DisplayStateOfPastTeamMembers( void )
{
	...
	if( fCurrentTeamMode == FALSE )
	{
	   ...
	   mprintf(  PERS_CURR_TEAM_COST_X, PERS_CURR_TEAM_COST_Y, pPersonelTeamStrings[ 5 ] );
		 wprintf( sString, L"%d", GetNumberOfDeadOnPastTeam( ) );
	   ...
	   wprintf( sString, L"%d", GetNumberOfLeftOnPastTeam( ) );
		 ...
		 wprintf( sString, L"%d", GetNumberOfOtherOnPastTeam( ) );
	...
	for(iCounter=0;iCounter <MAX_STATS; iCounter++)
	{
		switch(iCounter)
		{
		 case 0:
			 ...
			 if( iState == 0 )
			 {
			   wprintf(sString, L"%d/%d",0,gMercProfiles[iId].bLife);
			 }
			 else
			 {
				 wprintf(sString, L"%d/%d",gMercProfiles[iId].bLife,gMercProfiles[iId].bLife);
			 }
       ...
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 ...
		 case 1:
			 // agility
       wprintf(sString, L"%d",gMercProfiles[iId].bAgility);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		 
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
			 break;
		 case 2:
		  // dexterity
       wprintf(sString, L"%d",gMercProfiles[iId].bDexterity);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
			break;
		 case 3:
		 // strength
       wprintf(sString, L"%d",gMercProfiles[iId].bStrength);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
		 case 4:
		  // leadership
       wprintf(sString, L"%d",gMercProfiles[iId].bLeadership);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
		 case 5:
		  // wisdom
       wprintf(sString, L"%d",gMercProfiles[iId].bWisdom);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
		 case 6:
		  // exper
       wprintf(sString, L"%d",gMercProfiles[iId].bExpLevel);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
		 case 7:
			 //mrkmanship
       wprintf(sString, L"%d",gMercProfiles[iId].bMarksmanship);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
     case 8:
		  // mech
       wprintf(sString, L"%d",gMercProfiles[iId].bMechanical);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
     case 9:
		  // exp
       wprintf(sString, L"%d",gMercProfiles[iId].bExplosive);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
       ...
       wprintf(sString, L"%d",gMercProfiles[iId].bMedical);
		 ...
		 // kills
      mprintf((INT16)(pPersonnelScreenPoints[21].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[21].y,pPersonnelScreenStrings[PRSNL_TXT_KILLS]);		 
			wprintf(sString, L"%d",gMercProfiles[iId].usKills);
      FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[21].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
      mprintf(sX,pPersonnelScreenPoints[21].y,sString);
		 break;
		 case 15:
			// assists
			mprintf((INT16)(pPersonnelScreenPoints[22].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[22].y,pPersonnelScreenStrings[PRSNL_TXT_ASSISTS]);		 
			wprintf(sString, L"%d",gMercProfiles[iId].usAssists);
      FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[22].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
      mprintf(sX,pPersonnelScreenPoints[22].y,sString);
		 break;
		  case 16:
      ...
      sX += StringPixLength( L"%",  PERS_FONT );
		 ...
		 break;
		  case 17:
			// battles
			mprintf((INT16)(pPersonnelScreenPoints[24].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[24].y,pPersonnelScreenStrings[PRSNL_TXT_BATTLES]);
			wprintf(sString, L"%d",gMercProfiles[iId].usBattlesFought);
      FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[24].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
      mprintf(sX,pPersonnelScreenPoints[24].y,sString);
		 break;
		 case 18:
			// wounds
			mprintf((INT16)(pPersonnelScreenPoints[25].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[25].y,pPersonnelScreenStrings[PRSNL_TXT_TIMES_WOUNDED]);
			wprintf(sString, L"%d",gMercProfiles[iId].usTimesWounded);
      FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[25].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
      mprintf(sX,pPersonnelScreenPoints[25].y,sString);
		 break;
		}
...
void DisplayDepartedCharName( INT32 iId, INT32 iSlot, INT32 iState )
{
  ...
  SetFont(CHAR_NAME_FONT);
	...
	{
		//displaye 'married'
		wprintf( sString, L"%s", pPersonnelDepartedStateStrings[ DEPARTED_MARRIED ] );
	}
	else if(  iState == DEPARTED_DEAD )
	{
		wprintf( sString, L"%s", pPersonnelDepartedStateStrings[ DEPARTED_DEAD ] );
	}
	...
	else if( iId < BIFF )
	{
		...
		if( iState == DEPARTED_FIRED )
			wprintf( sString, L"%s", pPersonnelDepartedStateStrings[ DEPARTED_FIRED ] );
		else
			wprintf( sString, L"%s", pPersonnelDepartedStateStrings[ DEPARTED_CONTRACT_EXPIRED ] );
	}
	...
	else if( iId >= BIFF && iId <= BUBBA )
	{
		if( iState == DEPARTED_FIRED )
			...
			wprintf( sString, L"%s", pPersonnelDepartedStateStrings[ DEPARTED_QUIT ] );
	}
	//must be a RPC
	else
	{
...
//	wprintf( sString, L"%s", pPersonnelDepartedStateStrings[ iState ] );
							...
							else if( fATMFlags == 2 )
							{
								...
								if( GetFundsOnMerc( pSoldier ) >= wcstol( sTransferString, NULL, 10 ) )
								{
									if( ( wcstol( sTransferString, NULL, 10 ) % 10 ) != 0 )
									{
										...
										wprintf( sTransferString, L"%d", iValue );
										fReDrawScreenFlag=TRUE;
									}
									else
									{
		...
		case 0:
		{
			...
			UINT32 uiMinutesInDay = 24 * 60;
				...
				if(Menptr[iId].ubWhatKindOfMercAmI == MERC_TYPE__AIM_MERC || Menptr[iId].ubProfile == SLAY )
				{
					...
					{
						wprintf(sString, L"%d%s %d%s / %d%s",( iTimeLeftOnContract / uiMinutesInDay ), gpStrategicString[ STR_PB_DAYS_ABBREVIATION ], (iTimeLeftOnContract % uiMinutesInDay)/60, gpStrategicString[ STR_PB_HOURS_ABBREVIATION ], Menptr[iId].iTotalContractLength, gpStrategicString[ STR_PB_DAYS_ABBREVIATION ]);
					...
					{
						//DEF: removed 2/7/99
						wprintf(sString, L"%d%s / %d%s", (iTimeLeftOnContract % uiMinutesInDay)/60, gpStrategicString[ STR_PB_HOURS_ABBREVIATION ], Menptr[iId].iTotalContractLength, gpStrategicString[ STR_PB_DAYS_ABBREVIATION ]);
						mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[PRSNL_TXT_CURRENT_CONTRACT]);		
					}
				...
				{
//					wprintf(sString, L"%d%s / %d%s",Menptr[iId].iTotalContractLength, gpStrategicString[ STR_PB_DAYS_ABBREVIATION ], ( GetWorldTotalMin( ) -Menptr[iId].iStartContractTime ) / ( 24 * 60 ), gpStrategicString[ STR_PB_DAYS_ABBREVIATION ] );
...
//				 wprintf( sString, L"%d",uiDailyCost * Menptr[ iId ].iTotalContractLength );
				 wprintf( sString, L"%d", gMercProfiles[ Menptr[ iId ].ubProfile ].uiTotalCostToDate );
			 }
			 else if( Menptr[iId].ubWhatKindOfMercAmI == MERC_TYPE__MERC)
			 {
//					wprintf( sString, L"%d",gMercProfiles[ Menptr[ iId ].ubProfile ].sSalary * gMercProfiles[ Menptr[ iId ].ubProfile ].iMercMercContractLength );
					wprintf( sString, L"%d", gMercProfiles[ Menptr[ iId ].ubProfile ].uiTotalCostToDate );
			 }
			 else
			 {
...
DEF:3/19/99:
			 ...
			 {
			   wprintf( sStringA, L"%s", pPersonnelScreenStrings[ PRSNL_TXT_UNPAID_AMOUNT ] );
			 }
			 else
*/
			 {
				 wprintf( sStringA, L"%s", pPersonnelScreenStrings[ PRSNL_TXT_TOTAL_COST ]  );
			 }
			 ...
			 if( Menptr[iId].ubWhatKindOfMercAmI == MERC_TYPE__AIM_MERC)
			 {
				 ...
				 {
					 // 2 week contract
					 wprintf( sStringA, L"%d", gMercProfiles[Menptr[ iId ].ubProfile].uiBiWeeklySalary / 14 );
				   InsertCommasForDollarFigure( sStringA );
					 InsertDollarSignInToString( sStringA );
					 wprintf( sString, L"%s", sStringA );
				 }
				 else if( Menptr[iId].bTypeOfLastContract == CONTRACT_EXTEND_1_WEEK )
				 {
					 // 1 week contract
					 wprintf( sStringA, L"%d", gMercProfiles[Menptr[ iId ].ubProfile].uiWeeklySalary / 7 );
				   InsertCommasForDollarFigure( sStringA );
					 InsertDollarSignInToString( sStringA );
					 wprintf( sString, L"%s",  sStringA );
				 }
				 else
				 {
					 ...
					 wprintf( sStringA, L"%d", gMercProfiles[Menptr[ iId ].ubProfile].sSalary );
					 InsertCommasForDollarFigure( sStringA );
				   InsertDollarSignInToString( sStringA );
					 wprintf( sString,  L"%s", sStringA );
				 }
			 ...
			 {
//DEF: 99/2/7
//				 wprintf( sStringA, L"%d", gMercProfiles[Menptr[ iId ].ubProfile].sSalary * Menptr[ iId ].iTotalContractLength);
				 wprintf( sStringA, L"%d", gMercProfiles[Menptr[ iId ].ubProfile].sSalary );
				 InsertCommasForDollarFigure( sStringA );
				 InsertDollarSignInToString( sStringA );
				 wprintf( sString,   L"%s", sStringA );
		 ...
		 case 5:
		   // medical deposit		 
			...
			else
			{
				...
				wprintf(sString, L"%d",gMercProfiles[Menptr[iId].ubProfile].sMedicalDepositAmount);
